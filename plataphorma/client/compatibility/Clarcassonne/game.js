spritesC = {
	...
	CiudadC:      { sx: 500, sy: 0, w: 100, h: 100, frames: 1 },  
	CiudadD:      { sx: 600, sy: 0, w: 100, h: 100, frames: 1 },
	CiudadE:      { sx: 300, sy: 0, w: 100, h: 100, frames: 1 }, 
	CiudadF:      { sx: 1000, sy: 300, w: 100, h: 100, frames:1},
	CiudadG:      { sx: 1000, sy: 100, w: 100, h:100, frames:1},
	CiudadH:      { sx: 700, sy: 300, w: 100, h: 100, frames: 1 },
	CiudadI:      { sx: 700, sy: 200, w: 100, h: 100, frames: 1 },
	CiudadJ:      { sx: 700, sy: 100, w: 100, h: 100, frames: 1 },
	CiudadK:      { sx: 700, sy: 0, w: 100, h: 100, frames: 1 }, 
	CiudadL:      { sx: 500, sy: 500, w: 100, h: 100, frames: 1 },
	CiudadM:      { sx: 500, sy: 400, w: 100, h: 100, frames: 1 },
	CiudadN:      { sx: 600, sy: 400, w: 100, h: 100, frames: 1 },
	CiudadO:      { sx: 300, sy: 400, w: 100, h: 100, frames: 1 }, 
	CiudadP:      { sx: 400, sy: 300, w: 100, h: 100, frames: 1 }, 
	CiudadQ:      { sx: 300, sy: 200, w: 100, h: 100, frames: 1 },
	CiudadR:      { sx: 400, sy: 200, w: 100, h: 100, frames: 1 }, 
	CiudadS:      { sx: 300, sy: 100, w: 100, h: 100, frames: 1 },
	CiudadT:      { sx: 500, sy: 100, w: 100, h: 100, frames: 1 },
...
function SetPlayers (err, data) {
	...
	if (data.length >= 4) {
		Jugador4 = {nombre: data[3].nombre.slice(0,6)    , color: "ficha_verde", puntos:data[3].puntuacion, id: data[3].id, turno: 0};
	}
	if (data.length == 5) {
		Jugador5 = {nombre: data[4].nombre.slice(0,6)  , color: "ficha_gris", puntos:data[4].puntuacion, id: data[4].id, turno: 0};
	}
...
function setTurno (jugador) {
	if (nJugadores == 2) {
		...
		if (Jugador2.id == jugador.id) { getTurno().turno = 0; Jugador1.turno = 1; }
